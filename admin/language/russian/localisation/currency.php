...
$_['entry_code']           = 'Код:<br /><span class="help">Не изменяется, если валюта установлена по умолчанию. Должна соответствовать стандарту <a href="http://www.xe.com/iso4217.php" target="_blank">ISO code</a>.</span>';
...
$_['entry_decimal_place']  = 'Точность:<br /><span class="help">Количество знаков после запятой.</span>';
