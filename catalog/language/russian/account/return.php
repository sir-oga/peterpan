...
$_['text_agree']         = 'И прочитал и согласен <a class="colorbox" href="%s" alt="%s"><b>%s</b></a>';
...
// Error
$_['text_error']         = 'Запросы на возврат не найдены!';
...
$_['error_agree']        = 'Вы должны подтвердить %s!';
?>